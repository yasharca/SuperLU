 ...
 * </pre>
 */
void zGetDiagU(int_t n, LUstruct_t *LUstruct, gridinfo_t *grid, doublecomplex *diagU)
{
    ...
    doublecomplex *dblock, *dwork, *lusup;
    ...
    if ( !(dwork = doublecomplexMalloc_dist(jj)) ) ABORT("Malloc fails for dwork[]");
